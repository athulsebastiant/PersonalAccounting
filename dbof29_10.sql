...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2024 at 10:56 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pl32` ()   BEGIN
CREATE TEMPORARY TABLE profittable
SELECT ROW_NUMBER() OVER(order BY AccountID) AS row_num, AccountID,SPACE(50) as AccountName,SUM(CREDITAmount-debitAmount) as credit
from jrldetailed
where accountID IN (SELECT accountNo from coa where categoryID = 4) 
...
select sum(debit) into @TE from losstable;
select sum(credit) into @TI from profittable;

SELECT MAX(row_num) + 1 INTO @next_profit_row FROM profittable;
SELECT MAX(row_num) + 1 INTO @next_loss_row FROM losstable;

-- Insert totals with continued row numbers
insert into profittable(row_num, AccountName, credit) values(@next_profit_row, "Total Income", @TI);
insert into losstable(row_num, AccountName, debit) values(@next_loss_row, "Total Expenses", @TE);
...
select sum(debit) - @TE into @totalExpense from pl;
select sum(credit) - @TI into @totalIncome from pl;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SOA` (IN `AccountID` INT, IN `fromDate` DATE, IN `toDate` DATE)   BEGIN
    ...
    DATE(jrlmaster.createdDateTime) AS createdDate,
        jrlmaster.EntryID,
        jrlmaster.description AS JournalDes,
   ...
   -- DECLARE v_entity INT;
    ...
    WHILE JSON_EXTRACT(p_entries, CONCAT('$[', v_i, ']')) IS NOT NULL DO
      ...
      --  SET v_entity = NULLIF(JSON_UNQUOTE(JSON_EXTRACT(p_entries, CONCAT('$[', v_i, '].entity'))), 'null');
        ...
        -- Insert into jrldetailed
        INSERT INTO jrldetailed (EntryID, LineID, AccountID, description, DebitAmount, CreditAmount,createdBy)
        VALUES (v_description_id, v_i + 1, v_account,v_label, v_debit, v_credit,p_CreatedBy);
...
(11001, 'Cash', 1, 1, NULL, '2024-06-30 05:55:18', 'gooboy21', '2024-09-28 08:44:01'),
(11002, 'Accounts Receivable', 1, 1, NULL, '2024-06-30 05:55:18', 'gooboy21', '2024-09-27 13:26:58'),
...
(14005, 'Santo Sir', 1, 4, 'gooboy21', '2024-10-01 04:19:38', NULL, '2024-10-01 04:19:38'),
...
(50000, 'TV', 5, 1, 'gooboy21', '2024-09-28 05:33:48', NULL, '2024-09-28 05:33:48'),
...
(51007, 'Repair Expenses', 5, 1, 'gooboy21', '2024-10-29 05:42:19', NULL, '2024-10-29 05:42:19'),
...
(62, 1, 51006, NULL, 'bought c book', 200.00, 0.00, 'gooboy21', '2024-09-28 04:36:17', 'gooboy21', '2024-09-28 05:01:28'),
(62, 2, 13001, NULL, 'from sbi bank', 0.00, 200.00, 'gooboy21', '2024-09-28 04:36:17', 'gooboy21', '2024-09-28 05:01:28'),
(63, 1, 50000, NULL, 'Bought a new TV', 100.00, 0.00, 'gooboy21', '2024-09-28 05:36:48', NULL, '2024-09-28 05:36:48'),
(63, 2, 11001, NULL, 'cash paid', 0.00, 100.00, 'gooboy21', '2024-09-28 05:36:48', NULL, '2024-09-28 05:36:48'),
(64, 1, 12002, NULL, 'bought a printer', 5000.00, 0.00, 'gooboy21', '2024-09-29 04:17:47', 'gooboy21', '2024-09-29 12:35:14'),
(64, 2, 13001, NULL, 'paid from sbi', 0.00, 5000.00, 'gooboy21', '2024-09-29 04:17:47', 'gooboy21', '2024-09-29 12:43:04'),
(65, 1, 57001, NULL, 'bought chips', 20.00, 0.00, 'gooboy21', '2024-10-01 04:24:58', NULL, '2024-10-01 04:24:58'),
(65, 2, 11001, NULL, 'paid with cash', 0.00, 20.00, 'gooboy21', '2024-10-01 04:24:58', NULL, '2024-10-01 04:24:58'),
(66, 1, 12002, NULL, 'bought a machinery', 500.00, 0.00, 'gooboy21', '2024-10-01 04:34:52', NULL, '2024-10-01 04:34:52'),
(66, 2, 11001, NULL, 'paid with cash', 0.00, 500.00, 'gooboy21', '2024-10-01 04:34:52', NULL, '2024-10-01 04:34:52'),
(67, 1, 51007, NULL, 'repair to house', 650.00, 0.00, 'gooboy21', '2024-10-29 09:03:55', 'gooboy21', '2024-10-29 09:08:02'),
(67, 2, 13001, NULL, 'paid from sbi bank', 0.00, 650.00, 'gooboy21', '2024-10-29 09:03:55', 'gooboy21', '2024-10-29 09:09:44');
...
(62, '2024-09-28', 'C book', 'gooboy21', '2024-09-28 04:36:17', 'gooboy21', '2024-09-28 04:44:09'),
(63, '2024-09-28', 'purchase', 'gooboy21', '2024-09-28 05:36:48', NULL, '2024-09-28 05:36:48'),
(64, '2024-09-29', 'Bought a printer', 'gooboy21', '2024-09-29 04:17:47', 'gooboy21', '2024-09-29 05:01:11'),
(65, '2024-10-01', 'Bought Chips', 'gooboy21', '2024-10-01 04:24:58', NULL, '2024-10-01 04:24:58'),
(66, '2024-10-01', 'Purchased Machinery', 'gooboy21', '2024-10-01 04:34:52', NULL, '2024-10-01 04:34:52'),
(67, '2024-10-29', 'Repairs to house', 'gooboy21', '2024-10-29 09:03:55', 'gooboy21', '2024-10-29 09:07:50');
...
('root', '[{\"db\":\"ac2\",\"table\":\"accountsub\"},{\"db\":\"ac2\",\"table\":\"jrlmaster\"},{\"db\":\"evm\",\"table\":\"users\"},{\"db\":\"evm\",\"table\":\"payment\"},{\"db\":\"evm\",\"table\":\"events\"},{\"db\":\"evm\",\"table\":\"bookings\"},{\"db\":\"ac2\",\"table\":\"accountmaster\"},{\"db\":\"ac2\",\"table\":\"company_info\"},{\"db\":\"ac2\",\"table\":\"users2\"},{\"db\":\"ac2\",\"table\":\"entity\"}]');
...
('root', 'ac2', 'accountsub', '{\"sorted_col\":\"`CategoryID` ASC, `SubcategoryID` ASC\"}', '2024-10-27 10:08:36');
...
('root', '2024-10-29 09:38:37', '{\"Console\\/Mode\":\"show\",\"Console\\/Height\":18.99000000000001}');
